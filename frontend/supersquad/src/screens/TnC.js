  ...
  return (
    <div>
      <div className="container p-4" style={{ maxWidth: "768px" }}>
        ...
        <p className="text-center" id="title-company-name">
          Supersquad
        </p>
        <hr />
        <p>
        ...
        <p>
          ...
          <ul>
            <li>
              ...
              <span id="company-name">Supersquad</span>.
            </li>
            <li>
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              <strong>With Affiliates: We </strong>may share Your information
        ...
        posted on this page.
        <br />
        <br /> This Privacy Policy was last updated on{" "}
        <span id="gen-at">14-Oct-2024</span>
        <h2 class="text-center">Contact Us</h2>
        If you have any questions about this Privacy Policy, You can contact us
        via email at <span id="email">tech@gosupersquad.ocm</span>
        <hr />
      </div>
    </div>
  );
