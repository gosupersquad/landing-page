...
import H1 from "../../resources/images/trip_page/temp/h1.webp";
...
const TripPageCheckout = () => {
  ...
  const tripDetails = () => {
    return (
      <div style={{}}>
        ...
        >
          <p className="trip-details-title">Cat-Friendly Retreat With Aditya</p>
        </div>
        {isMobile && line()}
        {isMobile && (
          <div className="host-info">
            <img src={Host1} alt="Profile" className="host-info-image" />
            <p className="host-info-text">Hosted by Aditya</p>
          </div>
        )}
        {isMobile && line()}
        {isMobile && (
  ...
  const handleBook = () => {
    ...
    const data = [];
    const slug = "Cat-Friendly Retreat With Aditya";
      ...
      <div className="host-and-trip-details-container">
        ...
        <div className="trip-details">
          ...
          <div className="trip-details-item">
            ...
            <div className="trip-details-item-text">Sariska Tiger Reserve</div>
          </div>
        </div>
        {dashedLine()}
  ...
  const handleCloseModal = () => {
    window.open("https://gosupersquad.com/aditya/purrfect-escape", "_self");
  };
