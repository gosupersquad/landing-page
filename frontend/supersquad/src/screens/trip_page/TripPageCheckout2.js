...
import H1 from "../../resources/images/trip_page/temp2/h2.jpg";
...
const TripPageCheckout = () => {
      ...
      <div style={{}}>
        ...
        {isMobile && (
          <div className="host-info">
            ...
            <p className="host-info-text">Hosted by Manmeet, Parneet & Karan</p>
          </div>
        )}
        {isMobile && line()}
        {isMobile && (
          <div style={{ marginTop: 20 }} className="trip-details">
            <div className="trip-details-item">
              ...
              <div className="trip-details-item-text">8th - 10th Nov</div>
            </div>
            <div className="trip-details-item">
              <div className="trip-details-item-title">
              ...
              <div className="trip-details-item-text">Manali</div>
            </div>
          </div>
        )}
      </div>
  ...
  const handleBook = () => {
    ...
    const data = [];
    const slug = "Manali Weekend Escape with Manmeet, Parneet & Karan";
    ...
    return (
      <div style={{ marginTop: 32 }}>
        ...
        <p style={{ margin: "17px 0px" }} className="hurry-text">
          {/* ⌛ Hurry up! only 15 spots left! */}⌛ Only 15 spots available!
        </p>
      </div>
    );
  };
    ...
    return (
      <div className="host-and-trip-details-container">
        ...
        <div className="hurry-up-div">
          <p className="hurry-up-div-text">⌛ Only 15 spots available!</p>
        </div>
      </div>
    );
  };
  ...
  const handleCloseModal = () => {
    window.open(
      "https://gosupersquad.com/manali-with-manmeet-parneet-karan",
      "_self"
    );
  };
